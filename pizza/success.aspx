...
<html lang="en">
  <head runat="server">
    <title>Pizza Delicious | name</title>
    <meta charset="utf-8">
  	...
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class= "nav-item active"><asp:HyperLink ID="HyperLink2" runat="server" class="nav-link" NavigateUrl="login.aspx">LogIn</asp:HyperLink></li>
...
<section class="home-slider owl-carousel img" style="background-image: url(images/p-6.jpg);">

      <div class="slider-item" style="background-image: url(images/p-6.jpg);">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">

            <div class="col-md-7 col-sm-12 text-center ftco-animate">
                <h1>Welcome <asp:Label ID="Label1" runat="server" class="mb-3 mt-5 bread"></asp:Label></h1>
                <asp:Button ID="Button4" runat="server" Text="LogOut" class="btn btn-primary" OnClick="Button4_Click" Visible="false" />
                <br /><br />
                <%--<h1 class="mb-3 mt-5 bread">SuceessFully LogIn</h1>--%>
                <p class="breadcrumbs" style="size:20px"><span class="mr-2"><a href="index.aspx">Home</a></span>
                <span class="mr-2"><a href="menu.aspx">Menu</a></span></p>
            </div>
        ...
        <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <a href="menu.html"><button class="btn btn-warning btn-outline-warning">Order Here</button></a>
          </div>
        </div>
