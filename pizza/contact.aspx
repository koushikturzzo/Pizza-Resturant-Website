    ...
    <section class="ftco-section contact-section">
      <div class="container mt-5">
        <div class="row block-9">
	              ...
	              <h2 class="h4"><i class="far fa-address-book"></i>  &ensp;Contact Information</h2>
	            </div>
	            <div class="col-md-12 mb-3">
	              <p><span>Address:</span><text class="text-primary">  &ensp; 101 khanjahan ali road,khulna,bangladesh</text></p>
	            </div>
	            <div class="col-md-12 mb-3">
	              <p><span>Phone:</span> <a href="tel:++8801671769037">+8801671769037</a></p>
	            </div>
	            <div class="col-md-12 mb-3">
	              <p><span>Email:</span> <a href="mailto:pizzadelicious@gmail.com">pizzadelicious@gmail.com</a></p>
	            </div>
	            <div class="col-md-12 mb-3">
	              <p><span>Website:</span> <a href="https://pizzadelicious.com">PizzaDelicious.com</a></p>
	            </div>
						</div>
					</div>
          ...
          <div class="col-md-6 ftco-animate">
            <h1><i class='far fa-paper-plane' style='font-size:36px'></i>  &ensp;Leave a Message</h1>
            <text style="color: red"><b>All fields are required.</b></text><br><br>

            <form id="form3" runat="server" class="contact-form" method="post">
            	<div class="row">
            		<div class="col-md-6">
	                <div class="form-group">

	                  <asp:TextBox ID="name" runat="server" type="text" class="form-control" placeholder="Your Name" required=""></asp:TextBox>
                ...
                <div class="col-md-6">
	                <div class="form-group">
	                 ...
	                 <asp:TextBox ID="email" runat="server" type="text" class="form-control" placeholder="Your Email" required=""></asp:TextBox>
              ...
              <div class="form-group">
                ...
                <asp:TextBox ID="subject" runat="server" type="text" class="form-control" placeholder="Subject" required=""></asp:TextBox>

              </div>
              <div class="form-group">
                <asp:TextBox ID="message" runat="server" name="comments" cols="30" rows="7" TextMode="MultiLine" class="form-control" placeholder="Message" required=""></asp:TextBox>
              </div>
              <div class="form-group">

                <asp:Button ID="Button3" runat="server" type="submit" value="Send Message" Text="Send Message" OnClick="Button3_Click" class="btn btn-primary py-3 px-5" />
              </div>
                <div class="form=group">
...
<br>
    ...
    <section >
      <h2 class=text-warning style="text-align: center"><i class="fas fa-directions"></i>&ensp;Get In Touch</h2><br><br>
      <div class="mapouter"><div class="gmap_canvas"><iframe width="100%" height="400px" id="gmap_canvas" src="https://maps.google.com/maps?q=kuet%2Ckhulna%2Cbangladesh&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>Google Maps Generator by <a href="https://www.embedgooglemap.net">embedgooglemap.net</a></div><style>.mapouter{position:relative;text-align:right;height:400px;width:100%;}.gmap_canvas {overflow:hidden;background:none!important;height:400px;width:100%;}</style></div>
